 	...
 	<form id="demo-form-2" method="POST"  name="bindform">
        ...
        <div class="ui-dialog col-md-4 center-margin form-vertical modal-dialog" id="login-form">
            <div class="ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix">
                <span class="ui-dialog-title">图书管理登陆系统</span>
            </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-10">
                        <div class="form-input-icon">
                            ...
                            <input placeholder="请输入管理员账户" type="text" name="account" id="account" data-trigger="keyup" data-required="true" class="parsley-validated">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-10">
                        <div class="form-input-icon">
                            ...
                            <input placeholder="请输入密码" type="password" name="password" id="password"  data-trigger="change" data-required="true" class="parsley-validated">
                        </div>
                    </div>
                </div>
